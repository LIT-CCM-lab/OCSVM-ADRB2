...
if __name__ == "__main__":
	...
	parser.add_argument('-sg', '--subgraph', default = None, help='type of subgraph to use')
	parser.add_argument('-n', '--normalize', default =  True, help = 'Normalization of the graph similairty score')
	parser.add_argument('-m', '--mad', default = True, help = 'Perform model training using the MAD heuristic')
	parser.add_argument('-q', '--qms2', default = True, help = 'Perform model training using the QMS2 heuristic')
